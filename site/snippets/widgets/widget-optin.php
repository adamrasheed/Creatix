<div class="widget widget-cta--primary">
    ...
    <script async id="_ck_191551" src="https://forms.convertkit.com/191551?v=6"></script>
    <a rel="ck_modal" href="#ck_modal" class="widget__cta btn btn--primary btn--small">
        Click Here to Sign Up
    </a>
</div><!-- end widget optin -->